...
t.DecodeJSON = function(jsonString)
	assert(type(jsonString) == "string", "JSON Decoder expects string!")
	return game:GetService("HttpService"):JSONDecode(jsonString)
end

t.EncodeJSON = function(jsonTable)
	assert(type(jsonTable) == "table", "JSON Encoder expects table!")
	return game:GetService("HttpService"):JSONEncode(jsonTable)
end
