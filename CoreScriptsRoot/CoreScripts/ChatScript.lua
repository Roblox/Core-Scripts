...
local Chat = { 
			...
			Admins_List = {
								...
								'IMightBeLying', 'UristMcSparks', 'ITOlaurEN', 'Malcomso', 'HeySeptember', 'Stickmasterluke', 'windlight13', 'Stravant', 'imaginationsensation', 'Matt.Dusek', 'CrimmsonGhost', 'Mcrtest', 'maxvee', 'Coatp0cketninja', 'Screenme',
